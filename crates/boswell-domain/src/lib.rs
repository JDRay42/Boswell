...
pub use goal::{
    ChildKind, ChildRef, CollectOutcome, DescentGuard, DescentLimits, DescentStop, EdgeRole,
    ExpandResult, ExpandedCandidate, FactorReading, Goal, GoalEdge, GoalId, GoalQuery,
    GraphIntegrity, TraversalContext,
};
pub use identity::{
...
pub use tier::Tier;
pub use write_path::{
    authenticated_principal, entry_tier, validate_principal, Assurance, Authority,
    CorroborationFacts, DelegationChain, EvidenceType, Op, PrincipalShapeError, ProvenanceStamp,
    StampedReportOutcome, StampedWriteOutcome,
};
